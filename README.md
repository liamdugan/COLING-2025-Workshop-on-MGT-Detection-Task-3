...
However, in this task the texts will not be limited to any one domain and may come from many different domains, generative models, and decoding strategies. Your goal will be to create a detector that exhibits high levels of robustness across all of these models, domains, and decoding strategies while maintaining a low false positive rate.
